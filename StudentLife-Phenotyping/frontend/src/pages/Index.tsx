...
import { MentalHealthPanel } from "@/components/dashboard/MentalHealthPanel";
import { BehavioralPanel } from "@/components/dashboard/BehavioralPanel";
import { QuestionnairePanel } from "@/components/dashboard/QuestionnairePanel";
    ...
    <div className="min-h-screen flex w-full bg-background">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="sticky top-0 z-50 h-14 border-b border-border bg-card/80 backdrop-blur-xl flex items-center px-4 gap-3">
          ...
          <span className="font-semibold text-sm text-foreground">StudentLife</span>
        ...
        <main className="flex-1 overflow-y-auto">
          ...
          <footer className="border-t border-border py-4 mt-8">
            <p className="text-center text-xs text-muted-foreground">
              StudentLife Digital Health Monitoring · Biomedical Instrumentation © {new Date().getFullYear()}
            </p>
          </footer>
        </main>
      </div>
